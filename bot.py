...
# Пресеты под каждый таймфрейм (подобраны под ETH волатильность)
TF_PRESETS = {
    "5m": {
        # Скальп. Широкий SL + близкий TP (mean-reversion)
        "SL_ATR_MULT":    2.0,
        "TP_ATR_MULT":    2.0,
        "SL_PCT_MIN":     0.003,
        "SL_PCT_MAX":     0.015,
    ...
    "15m": {
        # Оптимум для системы баллов. WR 45-55%, удержание 1-4ч
        "SL_ATR_MULT":    1.5,
        "TP_ATR_MULT":    2.5,
        "SL_PCT_MIN":     0.005,
        "SL_PCT_MAX":     0.025,
    ...
    "1h": {
        # Свинг. WR 50-60%, удержание 4-12ч
        "SL_ATR_MULT":    1.5,
        "TP_ATR_MULT":    3.0,
        "SL_PCT_MIN":     0.010,
        "SL_PCT_MAX":     0.040,
...
WATCHDOG_THRESHOLD = max(15 * 60, SCAN_INTERVAL * 4)
